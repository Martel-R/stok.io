...
import { Loader2, PlusCircle, Trash2, ArrowLeft, Camera, User, Save, CheckCircle, Clock, Calendar, Upload, Mail, Phone, Home, Briefcase } from 'lucide-react';
                        ...
                        <TabsContent value="customer" className="space-y-6 mt-4">
                             <Card>
                                ...
                                <CardContent className="space-y-3 text-sm">
                                    <div className="flex items-center gap-2"><User className="h-4 w-4 text-muted-foreground" /><span>{attendance.customerName}</span></div>
                                    <div className="flex items-center gap-2"><Briefcase className="h-4 w-4 text-muted-foreground" /><span>Profissional: {attendance.professionalName}</span></div>
                                    <div className="flex items-center gap-2"><Calendar className="h-4 w-4 text-muted-foreground" /><span>Data: {attendance.date ? format(attendance.date.toDate(), 'dd/MM/yyyy') : '...'}</span></div>
                                        ...
                                        {attendance.items.map(item => (
                                            <div key={item.id} className="flex justify-between items-center p-2 rounded-md bg-muted">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">{item.quantity} x R$ {item.price.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <p className="font-semibold">R$ {item.total.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3 text-sm">
                            ...
                            <div className="flex justify-between items-baseline">
                                ...
                                <p className="text-3xl font-bold">R$ {attendance.total.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                            </div>
                        </CardContent>
                    </Card>
