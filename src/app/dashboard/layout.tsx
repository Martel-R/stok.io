...
import { Home, Package, BarChart, ShoppingCart, Bot, FileText, LogOut, Loader2, Users, Settings, ChevronsUpDown, Check, Building, Gift, AlertTriangle, CreditCard, Component, LifeBuoy, Calendar, Briefcase, Menu, LogIn, ShieldAlert, ArrowDownCircle, Archive, MessageCircle, Monitor } from 'lucide-react';
...
function DashboardNav() {
    ...
    const navItems = [
        ...
        { href: '/dashboard/cash-monitoring', label: 'Monitoramento de Caixas', icon: Monitor, module: 'cashMonitoring' },
